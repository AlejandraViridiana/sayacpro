...
class User(models.Model):
    ...
    nameUser = models.CharField(max_length=100,verbose_name = "Nombre completo",blank=True, null=True)
    ...
    emailUser = models.EmailField(max_length=100,verbose_name = "Correo UABC",blank=True, null=True)
    rolSelect = (
        ( None, 'Selecciona estado'),
