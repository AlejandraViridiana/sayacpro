...
class AccountsRegisterModelForm(forms.ModelForm):
    class Meta:
        model = Accounts
        fields = ['firsName','lastName','emailAccount','passwordAccount','confirmPasswordAccount']

    firsName = forms.CharField(required=True,
    ...
    emailAccount = forms.CharField(required=True,
    widget= forms.TextInput(attrs={"type":"password","placeholder":"Contraseña","class": "form-control input_pass",
        "id": "my-id-passUser","rows": 1,"cols": 22}))

    passwordAccount = forms.CharField(required=True,
    widget= forms.TextInput(attrs={"type":"password","placeholder":"Contraseña","class": "form-control input_pass",
        "id": "my-id-passUser","rows": 1,"cols": 22}))

    confirmPasswordAccount = forms.CharField(required=True,
    widget= forms.TextInput(attrs={"type":"password","placeholder":"Contraseña","class": "form-control input_pass",
        "id": "my-id-passUser","rows": 1,"cols": 22}))
    ...
    def clean(self):
        ...
        super(AccountsRegisterModelForm, self).clean()        
